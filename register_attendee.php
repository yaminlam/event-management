...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($event && $event['available_capacity'] > 0) {
            $insertQuery = $conn->prepare("INSERT INTO attendee_registrations (event_id, attendee_name, attendee_email, registered_at)
                                   VALUES (:event_id, :attendee_name, :attendee_email, NOW())");
